...
export default [
  ...
  route("widerruf", "routes/public-withdrawal.tsx"),
  ...
  layout("routes/internal-layout.tsx", [
    ...
    route("crm/organizations/:organizationId/partner", "routes/organization-partner.tsx"),
    ...
    route("case-studies/:caseStudyId", "routes/case-study-detail.tsx"),
    route("referrals", "routes/referrals.tsx"),
    route("referrals/:referralId", "routes/referral-detail.tsx"),
    route("after-sales", "routes/after-sales.tsx"),
    ...
    route("properties/:propertyId/document-requirements", "routes/property-document-requirements.tsx"),
