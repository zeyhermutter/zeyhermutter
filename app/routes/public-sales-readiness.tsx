...
export default function PublicSalesReadiness() {
  ...
  return <main className="public-site sales-check-page">
    <PublicHeader />
    <section className="sales-check-hero"><div><p className="public-eyebrow">Verkaufsfertig-Check</p><h1>Das Verkaufspotenzial Ihrer Immobilie beginnt vor dem Inserat.</h1><p>Wir prüfen vor der Vermarktung, welche Maßnahmen den Marktauftritt und die Verkaufsperspektive Ihrer Immobilie voraussichtlich sinnvoll verbessern können – und welche Sie sich sparen können. Danach übernehmen wir auf Wunsch Vorbereitung, Vermarktung und Verkauf.</p><a className="public-primary-button dark" href="#anfrage">Verkaufspotenzial prüfen lassen</a></div><aside aria-label="Ziel des Verkaufsfertig-Checks"><span>Unser Ziel</span><strong>Sinnvoll vorbereiten</strong><strong>Klar positionieren</strong><strong>Stark vermarkten</strong><strong>Bewusst entscheiden</strong></aside></section>
