...
export async function action({ request, context }: Route.ActionArgs) {
  ...
  if (text(fd, HONIGTOPF_FELD, 120)) return data<ActionResult>({ ok: "Vielen Dank. Ihre Anfrage wurde entgegengenommen." });
...
export default function PublicSalesReadiness() {
  ...
  return <main className="public-site sales-check-page">
    <PublicHeader />
    <section className="sales-check-hero"><div><p className="public-eyebrow">Verkaufsstrategie-Check · zusätzliche Option vor der Vermarktung</p><h1>Erst klären, was Ihre Immobilie braucht. Dann professionell verkaufen.</h1><p>Der Verkaufsstrategie-Check ergänzt unsere klassische Maklerleistung, wenn vor dem Marktstart noch offen ist, ob die Immobilie direkt verkauft oder gezielt vorbereitet werden sollte. Wir vergleichen die realistischen Wege – und übernehmen anschließend auf Wunsch die Vermarktung und den Verkauf.</p><a className="public-primary-button dark" href="#anfrage">Verkaufsweg prüfen lassen</a></div><aside aria-label="Ziel des Verkaufsstrategie-Checks"><span>Teil unseres Maklerprozesses</span><strong>Ist-Zustand prüfen</strong><strong>Aufbereitung abwägen</strong><strong>Aufwand einordnen</strong><strong>Danach vermarkten</strong></aside></section>
