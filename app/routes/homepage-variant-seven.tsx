...
import type { Route } from "./+types/homepage-variant-seven";
...
function PreviewBar() {
  return (
    <div className="hv-preview-bar">
      ...
      <strong>Version 7 · Makler & Verkaufsfertig</strong>
      <div><Link to="/homepage-varianten/6">← 6</Link><span /></div>
    </div>
  );
}

export default function HomepageVariantSeven() {
  return (
