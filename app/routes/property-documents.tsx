...
export default function PropertyDocuments() {
  ...
  return <main className="editor-shell">
    <header className="editor-header"><div><Link className="back-link" to={`/properties/${property.id}`}>← {property.property_number}</Link><p className="eyebrow">Modul 02 · Dokumente</p><h1 className="editor-title">Dokumente</h1><p className="editor-meta">{property.internal_title} · private Ablage · versioniert</p></div><div className="header-user"><span className="badge">{__APP_ENV_LABEL__}</span><small>{profile.display_name}</small></div></header>
